...
(async() => {
    ...
    Nunjucks.configure(Path.join(__dirname, `../public/`), { autoescape: false });
    ...
    files
        ...
        .forEach( async it => {
            ...
            await Fsp.writeFile(`${templateFilePath.substring(0, templateFilePath.length - 4)}.html`, pageData);
        });
})();