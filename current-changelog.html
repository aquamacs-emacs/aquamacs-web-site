...
Changes--1.0b</A>
</H2><SMALL CLASS="SMALL"><SMALL CLASS="SMALL"><SMALL CLASS="SMALL"></SMALL></SMALL></SMALL>
<P>
<SMALL CLASS="SMALL"><SMALL CLASS="SMALL"><SMALL CLASS="SMALL"></SMALL></SMALL></SMALL>
<UL>
<LI>Based on GNU Emacs 22.1.

<P>
</LI>
<LI>Java support has just gotten a lot better. JDEE is a complete,
	...
	Tools. Visit <TT><A NAME="tex2html34"
  HREF="http://jdee.sunsite.dk">http://jdee.sunsite.dk</A></TT> for more information.

<P>
</LI>
<LI>Toolbar: The icons have been completely redesigned. The colors
...
<UL>
<LI>New, open, save/save as, revert buffer
</LI>
<LI>Undo, redo
</LI>
<LI>Cut/copy/paste
...
<LI>Spell-check buffer (ispell-buffer)
</LI>
<LI>Print
</LI>
<LI>Make a new frame
...
<UL>
<LI>Preferences, Revert Buffer, Kill Buffer: Jasper Hauser
</LI>
<LI>New Frame, Recent Files, Spell-check: Nuovext Project
</LI>
<LI>all other icons: Adrian Chromenko and David Reitter
...
<LI>Spell-Checking can now be found in the Edit menu, not in
...
<LI>Spell-Checking now supports the popular cocoAspell package,
...
<LI>Formatting (filling) text with M-q (Option-q) is a bit more
...
<LI>one-buffer-one-frame-mode is more compatible to the normal Emacs
...
<LI>Undo as in the original Emacs is available again via
...
<LI>Apple-2 can now be used to split the window into two (like C-x
	2), Apple-1 will undo that split (like C-x 1).

<P>
</LI>
<LI>Cut/Copy/Paste with the secondary selection (use Option + mouse)
...
<LI>The current major mode may be changed in the context menu

<P>
</LI>
<LI>Emulate-Mac-German|Italian|...-Keyboard-Modes now allow you to
...
<LI>Default colors in help and *Messages* frames/buffers revised.
	Suggested by Charles Bailey

<P>
</LI>
<LI>Recently opened files that were opened from the "Recent Files"
...
<LI>Clicking into raised frames (windows) that are not the selected
...
<LI>Creator codes for loaded files are maintained and not always
...
<LI>Updated AUCTeX (11.84). [M-x latex-mode].
	XeTeX users: please customize `TeX-command-list' to call XeTeX
	directly.

<P>
</LI>
<LI>Haskell mode included (2.3). [M-x haskell-mode]

<P>
</LI>
<LI>RubyOnRails support via emacs-rails included (0.5.3)
					[M-x rails-minor-mode, with M-x ruby-mode]

<P>
</LI>
<LI>ACT-R support. [M-x actr-mode]

<P>
</LI>
<LI>Menu Bar fixes. (Disabled menu bar entries when frames invisible.)

<P>
</LI>
<LI>Aquamacs menu name shortened.
	Suggested by Enrico Franconi

<P>
</LI>
<LI>Accessibility in OS X fixes (simulated clicks on Window elements)
	Suggested by Alexis Gallagher
	Patch by Yamamoto Mitsuharu

<P>
</LI>
<LI>HTML files (and others) can be opened in the system's default
	browser again. This applies to C-c C-z v in html-helper-mode and
	other modes using `browse-url'.

<P>
</LI>
<LI>Tramp files (i.e. remote files loaded with
...
<LI>1.0a: Some documentation of Emacs functions (C-h f setq RET, e.g.) was not available on PPC Macs.
  Reported by David Sagan and Bill Rising.
</LI>
<LI>1.0a: Some additional executables like movemail did not work on PPC Macs.
Reported by Barbara Shirtcliff.

<P>
</LI>
<LI>1.0b: Ruby-mode included in new-buffer/change major mode menu

<P>
</LI>
<LI>1.0b: The underlying source code is now fixed to be GNU Emacs 22.1 plus Aquamacs extensions. 

<P>
</LI>
<LI>1.0b: On older PPC Macs, text input was only updated slowly whenever the tool-bar (icons at the top of the frame) was turned on.

<P>
</LI>
<LI>1.0b: Gnus did not work correctly. Reported by Martin J&#248;rgensen.

<P>
</LI>
<LI>1.0b: M-x tile-frames-horizontally/vertically fixed. Patch by Ben Hyde. Updated to new `oneonone' library version, code by Drew Adams.

<P>
</LI>
<LI>1.0b: Moving the point left or right with the arrow keys could cause an error message ``Mark inactive'' to appear in certain circumstances. Reported by Michel Charpentier.

<P>
</LI>
</UL>Thanks for supplying build machines: Toby Blake (U Edinburgh),
